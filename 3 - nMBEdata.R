...
for(i in cont){
  ...
  for(k in thf_info$kset){
    for(j in 1:NCOL(tilde)){
      nMBEtibble <- add_row(nMBEtibble, 
                             k = k,
                             id = colnames(tilde)[j],
                             comb =  str_sub(i, 2, -1),
                             method =  "cs",
                             type = c("tilde", "tilde0", "osqp"),
                             value = c(MBE(test[kid==k,j,], tilde[kid==k,j,]),
                                       MBE(test[kid==k,j,], tilde0[kid==k,j,]),
                                       MBE(test[kid==k,j,], tilde_nn[kid==k,j,])),
                             h = 0
      )
      ...
      nMBEtibble <- add_row(nMBEtibble, 
                             ...
                             method =  "cs",
                             type = c("tilde", "tilde0", "osqp"),
                             value = c(MBE(test[kid==k & opday == 1,j,], 
                                            tilde[kid==k & opday == 1,j,]),
                                       MBE(test[kid==k & opday == 1,j,], 
      ...
      nMBEtibble <- add_row(nMBEtibble, 
                             ...
                             method =  "cs",
                             type = c("tilde", "tilde0", "osqp"),
                             value = c(MBE(test[kid==k & opday == 2,j,], 
                                            tilde[kid==k & opday == 2,j,]),
                                       MBE(test[kid==k & opday == 2,j,], 
...
for(k in thf_info$kset){
  for(j in 1:NCOL(base)){
    nMBEtibble <- add_row(nMBEtibble, 
                           ...
                           method =  "none",
                           type = "none",
                           value = c(MBE(test[kid==k,j,], base[kid==k,j,])),
                           h = 0
    )
  ...
  for(k in thf_info$kset){
    for(j in 1:NCOL(tilde)){
      nMBEtibble <- add_row(nMBEtibble, 
                             ...
                             value = c(MBE(test[kid==k,j,], tilde[kid==k,j,]),
                                       MBE(test[kid==k,j,], ddot[kid==k,j,]),
                                       MBE(test[kid==k,j,], yang[kid==k,j,]),
                                       MBE(test[kid==k,j,], tilde0[kid==k,j,]),
                                       MBE(test[kid==k,j,], tilde_nn[kid==k,j,])),
                             h = 0
      )
...
for(k in thf_info$kset){
  for(j in 1:NCOL(BU)){
    nMBEtibble <- add_row(nMBEtibble, 
                           ...
                           method =  "t",
                           type = "none",
                           value = c(MBE(test[kid==k,j,], BU[kid==k,j,])),
                           h = 0
    )
...
for(k in thf_info$kset){
  for(j in 1:NCOL(pers)){
    nMBEtibble <- add_row(nMBEtibble, 
                           ...
                           method =  "bf",
                           type = "none",
                           value = c(MBE(test[kid==k,j,], pers[kid==k,j,])),
                           h = 0
    )
...
for(k in thf_info$kset){
  for(j in 1:NCOL(TIER)){
    nMBEtibble <- add_row(nMBEtibble, 
                           ...
                           method =  "ctbu",
                           type = "none",
                           value = c(MBE(test[kid==k,j,], TIER[kid==k,j,])),
                           h = 0
    )
...
save(nMBEdata, file = "./data/nMBEdata.RData")